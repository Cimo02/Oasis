...
let flow = ['index.html', 'question1.html', 'question2.html', 'question3.html', 'calibrationPage.html', 'app.html'];
...
const beginQuestions = () => {
  ...
  setTimeout(() => window.location.href = flow[flow.indexOf(fileName) + 1], 1000);
};
...
const back = () => {
  fadeAnimations();
  setTimeout(() => window.location.href = flow[flow.indexOf(fileName) - 1], 2000);
};
